...
console.log(document.querySelector(".timer-group"));
        var selected = {
...
console.log(document.querySelector(".selection-group-#image1"));

function endingDisplayExclude(image) {
    document.querySelector(".timer-group").remove();
    document.querySelector(image + "-container").remove();
    document.querySelector(".select-page").style.justifyContent = "center";
...
function start() {
    ...
    document.querySelector(".logo img").className = "fade-in";
}
